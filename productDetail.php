        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <div class="col-md-6">
                <span class="box-title">Detail Produk </span> 
...
if (isset($_GET['productID'])) {
    ...
    header('Location:productData.php');
      ...
      $sql_text= "SELECT * FROM as_products 
              WHERE productID='$id'";
              $text = mysqli_query($conn, $sql_text);

      $sql_supplier= "SELECT * FROM as_suppliers 
              WHERE supplierID='$supplierID'";
              $query_supplier = mysqli_query($conn,$sql_supplier);
              $supplier= mysqli_num_rows($query_supplier);

      $sql_brand= "SELECT * FROM as_brands 
              WHERE brandID='$brandID'";
              $query_brand = mysqli_query($conn,$sql_brand);
              $brand= mysqli_num_rows($query_brand);

      $sql_category="SELECT * FROM as_categories 
              WHERE categoryID='$categoryID'";
              $query_category = mysqli_query($conn,$sql_category);
              $category= mysqli_num_rows($query_category);
...
<form action="#" method="POST">
 ...
 if (mysqli_num_rows($text) > 0) {
        // jika ada tampilkan kedalam tabel
                      $data = mysqli_fetch_assoc($text);
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>supplierName</td>";
                      $strTbl .= "<td>";
                          if ($supplier>0){
                            foreach ($query_supplier as $key => $value) { 
                            $strTbl.= ": ".$value['supplierName'];
                            }
                          }else{
                            echo "data tidak ada";
                          }
                      ...
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>categoryName</td>";
                      $strTbl .="<td>";
                          if ($category>0) {
                            foreach ($query_category as $key => $value) { 
                              $strTbl.= ": ".$value['categoryName'];
                            }
                          }else{
                      ...
                      $strTbl .="<td>";
                          if ($brand>0) {
                            foreach ($query_brand as $key => $value) { 
                             $strTbl .= ": ".$value['brandName'];
                            }
                          }else{
                            echo "<option value='0'> data tidak ada</option>";
                          }
                      ...
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>productBarcode</td>";
                      $strTbl .= "<td> : ".$data['productBarcode']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>productName:</td>";
                      $strTbl .= "<td> : ".$data['productName']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>productImei</td>";
                      $strTbl .= "<td> : ".$data['productImei']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>productBuyPrice</td>";
                      $strTbl .= "<td> : ".$data['productBuyPrice']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>productSalePrice</td>";
                      $strTbl .= "<td> : ".$data['productSalePrice']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>productDiscount</td>";
                      $strTbl .= "<td> : ".$data['productDiscount']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>productStock</td>";
                      $strTbl .= "<td> : ".$data['productStock']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>productNote</td>";
                      $strTbl .= "<td> : ".$data['productNote']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      ...
                      $strTbl .= "<td> : ".$usercreate['userFullName']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
