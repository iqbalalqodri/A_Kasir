...
<li class="active treeview">
 ...
 <ul class="treeview-menu">
    ...
    <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="categoryData.php"><i class="fa fa-database"></i> Daftar Kategori</a></li>
          ...
          <div class="box">
            <div class="box-header with-border">
              <div class="col-md-6">
                ...
                <a class='btn btn-xs  btn-success' href="categoryTambah.php"><i class ='fa fa-plus'></i> Tambah Kategori </a>
              </div>
              <div class="box-tools">
...
<?php  
      ...
      $categoryData = mysqli_query($conn, $sql);
      ...
      $totalRow = mysqli_num_rows($categoryData);
      ...
      $sqlHal = mysqli_query($conn," SELECT * FROM as_categories LIMIT $start, $perHalaman");
      // variable nomor urut
      $nomor = $start+1;
    ...
    $sql = "SELECT * FROM as_categories";
      ...
      $tbl.= "<tr>";
      $tbl.= "<td>No</td>";
      $tbl.= "<td>Nama category</td>";
      $tbl.= "<td>Status category</td>";
      $tbl.= "<td>dibuat pada</td>";
      $tbl.= "<td>dibuat oleh</td>";
      $tbl.= "<td>diedit pada</td>";
      $tbl.= "<td>diedit oleh</td>";
      $tbl.= "<td>aksi</td>";
      $tbl.= "</tr>";
      // variable nomor urut
      ...
      if (mysqli_num_rows($sqlHal) > 0) {
       ...
       while ( $value= mysqli_fetch_assoc($sqlHal)) {
          ...
          $tbl.= "<td>
          <a class='btn btn-xs btn-primary' href='categoryDetail.php?categoryID=".$value['categoryID']."'><i class='fa fa-eye'></i></a>
          <a class='btn btn-xs btn-warning' href=categoryUpdate.php?categoryID=".$value['categoryID']."><i class='fa fa-edit'></i></a>
          <a class='btn btn-xs btn-danger' href='javascript:hapus(".$value['categoryID'].")'><i class='fa fa-trash'></i></a></td>";
          $tbl.= "</tr>";
