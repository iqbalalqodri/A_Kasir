...
<head>
  ...
  <title>Delta Microtech | Dashboard</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <link rel="ionicons" type="text/css" href="">
  <!-- Bootstrap 3.3.7 -->
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="dist/css/skins/_all-skins.min.css">
<script type="text/javascript" src="my.js"></script> <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="home.php" class="logo">
      ...
      <span class="logo-lg"><b>Delta</b>Microtech</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          $sql_USER="SELECT * FROM as_users WHERE userID='$user'";
                    ...
                    if ($userID > 0) {
                            ...
                            echo "<img src=image/".$user['gambar']." class='user-image' alt='User Image'>";  
                    }
                    ?>
