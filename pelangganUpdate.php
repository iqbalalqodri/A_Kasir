      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="penggunaTambah.php"><i class="fa fa-user-plus"></i> Tambah pelanggan</a></li>
          </ul>
        </li>
    ...
    <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="sales_report.php"><i class="fa fa-circle-o"></i> Daftar Transaksi</a></li>
          </ul>
        </li>
                <li class="treeview">
          <a href="#">
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <div class="col-md-6">
                <span class="box-title">input Brand Baru </span> 
...
if (isset($_GET['kode_pelanggan'])) {
      $Peln = $_GET['kode_pelanggan'];
  } else{
      // jika tidak ada redirect ke index.php
      // header('Location:pelangganData.php');
  }

$sql_kode="SELECT * FROM as_customers where  kode_pelanggan='$Peln'";
$hasil=mysqli_query($conn,$sql_kode);
if (mysqli_num_rows($hasil) > 0) {
 ...
 ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="name" type="text" class="form-control" placeholder="nama"  required="" value="<?php echo $Pelanggan['name'] ?>">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="address" type="text" class="form-control" placeholder="alamat"  required="" value="<?php echo $Pelanggan['address'] ?>">
                  </div>
                </div>
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="telphone" type="text" class="form-control" placeholder="telpon"  required="" value="<?php echo$Pelanggan['telphone'] ?>">
                  </div>
                </div>
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="email" type="text" class="form-control" placeholder="email"  required="" value="<?php echo $Pelanggan['email'] ?>">
                  </div>
                </div>
 ...
 <?php 
  ...
  if (isset($_POST['submit'])) {
    ...
    $tambah = "UPDATE as_customers SET name='$name',
    address='$address',
    telphone='$telphone',
    email='$email' where kode_pelanggan ='$Peln'  ";
      if (mysqli_query($conn,$tambah)) {
          // header("location:brandData.php");
        echo "update pengguna berhasil";
      }else{
          echo "maaf data gagal disimpan";
      }
  }
  ?>
  <a href="pelangganData.php">[ back ]</a>
