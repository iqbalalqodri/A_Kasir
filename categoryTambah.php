 ...
 <ul class="treeview-menu">
    ...
    <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="categoryTambah.php"><i class="fa fa-plus"></i> Tambah Kategori</a></li>
          </ul>
        </li>
</ul>
</li>
              ...
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="box-body">
                  ...
                  <label>               
                  <input type="radio" name="status" value="Y" required="">Ready
                  </label>  
                  <label>
                  <input type="radio" name="status" value="N">UnReady <br>
                  </label>
                  <table>
                  <tr>
                  <td>
...
$tambah = "INSERT INTO as_categories 
(categoryName,categoryStatus,createdUserID,createdDate,modifiedUserID,modifiedDate) 
 VALUES (' $Kategori','$status','$createdUserID','$createdDate','$modifiedUserID','$modifiedDate')";
      if (mysqli_query($conn,$tambah)) {
          // header("location:categoryData.php");
          echo "tambah kategori berhasil";
      }else{
