      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="penggunaTambah.php"><i class="fa fa-user-plus"></i> Tambah pelanggan</a></li>
          </ul>
        </li>
...
<form action="#" method="POST" class="form-horizontal">
              ...
              <div class="box-body">  
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="telphone" type="text" class="form-control" placeholder="telpon"  required="">
                  </div>
                </div>
                 <div class="form-group">
 ...
 <?php 
  ...
  if (isset($_POST['submit'])) {
    ...
    $tambah = "INSERT INTO as_customers (
    name,
    address,
    telphone,
    email)
