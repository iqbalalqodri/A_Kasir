        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <div class="col-md-6">
                <span class="box-title">Detail Supplier </span> 
...
if (!isset($_SESSION['userlevel'])){
  ...
  if (isset($_GET['supplierID'])) {
    ...
    header('Location:supplayertData.php');
  } 

      // query SQL menampilkan data dari table tbl_biodata
      $sql_text= "SELECT * FROM as_suppliers 
              WHERE supplierID='$id'";
     ...
     <?php
      ...
      if (mysqli_num_rows($text) > 0) {
        // jika ada tampilkan kedalam tabel
                      ...
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>supplierCode</td>";
                      $strTbl .= "<td> : ".$data['supplierCode']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>supplierName:</td>";
                      $strTbl .= "<td> : ".$data['supplierName']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>supplierAddress</td>";
                      $strTbl .= "<td> : ".$data['supplierAddress']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>supplierPhone</td>";
                      $strTbl .= "<td> : ".$data['supplierPhone']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>supplierFax</td>";
                      $strTbl .= "<td> : ".$data['supplierFax']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>supplierContactPerson</td>";
                      $strTbl .= "<td> : ".$data['supplierContactPerson']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>supplierCPHp</td>";
                      $strTbl .= "<td> : ".$data['supplierCPHp']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
                      $strTbl .= "<td>supplierStatus</td>";
                      $strTbl .= "<td> : ".$data['supplierStatus']."</td>";
                      $strTbl .= "</tr>";
                      $strTbl .= "<tr>";
