 ...
 <ul class="treeview-menu">
    ...
    <li class=" active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="brandTambah.php"><i class="fa fa-plus"></i> Tambah Brand</a></li>
          </ul>
        </li>
            ...
            <!-- form start -->
              <div class="box-body">  
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="namabrand" type="text" class="form-control" placeholder="nama brand"  required="">
                  </div>
                </div>
                </div>
    ...
    modifiedDate)
     ...
     '$modifiedDate')";
      if (mysqli_query($conn,$tambah)) {
        ...
        echo "tambah brand berhasil";
      }else{
          echo "maaf data gagal disimpan";
      }
  }
  ?>
  <a href="brandData.php">[ back ]</a>
